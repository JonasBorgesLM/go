...
func (x *OrderList) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *OrderList) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
func (x *OrderListResponse) GetOrders() []*OrderList {
	if x != nil {
		return x.Orders
	}
	return nil
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x64, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x3a, 0x0a,
	...
	0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0x80, 0x01, 0x0a, 0x0c, 0x4f, 0x72,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x0a, 0x4c, 0x69,
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.OrderListResponse.orders:type_name -> pb.OrderList
